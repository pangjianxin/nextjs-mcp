...
/// </summary>
[Serializable]
public class CorporateInfoDto : AuditedEntityDto<Guid>, IHasConcurrencyStamp
{
    /// <summary>
    /// 人员规模
    /// </summary>
    ...
    public List<ChangeInfoDto>? ChangeInfos { get; set; }
    public List<AdministrativeLicenseDto>? AdministrativeLicenses { get; set; }
